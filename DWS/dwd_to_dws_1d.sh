...
dws_car_alarm_1d="insert into ${APP}.dws_car_alarm_1d partition (dt='${do_date}')
select vin,
       count(*),
...
dws_car_motor_1d="insert overwrite table ${APP}.dws_car_motor_1d partition (dt='${do_date}')
select
    vin,
